...
const Nav = () => {
    ...
    return (
        <div className='flex'>
            <div className='h-20 w-screen shadow-lg flex justify-end'>
                ...
                <div className={`absolute top-0 bg-azul w-[60%] h-full border-r border-white text-white font-semibold ease-in-out duration-500 ${transition} z-40 flex flex-col`}>
                    <div className='flex justify-center pt-4 pb-14 border-b border-white'>Bike Mobi</div>
                    <Link className='p-4 border-b border-white' href='/classsificados'>Classificados</Link>
            ...
            <div className='bg-azul md:p-4 p-3 md:w-36 w-24 md:rounded-br-[72px] rounded-br-[48px] absolute left-0'>
