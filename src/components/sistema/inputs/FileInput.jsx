...
const FileInput = (props) => {
    ...
    if (file || props.defaultValue) {
        ...
        bg = (
            <label for="dropzone-file" className="flex flex-col items-center w-full max-w-lg p-5 mx-auto text-center bg-white border-2 border-cinza border-dashed cursor-pointer dark:bg-gray-900 dark:border-gray-700 rounded-xl">
