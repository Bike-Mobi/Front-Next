                ...
                {manutencoesFiltradas?.map((manutencao, index) => {
                  ...
                  <tr key={index}>
                      ...
                      <td>
                        ...
                        {manutencao.photo_1 ? (
                            <img src={`${process.env.https://bikemobi.com.br/api}/manutencaoFoto/${manutencao.photo_1}`} className='w-12 h-12 object-cover rounded-lg' alt="" />
                          ) : null}
                          {manutencao.photo_2 ? (
                            <img src={`${process.env.https://bikemobi.com.br/api}/manutencaoFoto/${manutencao.photo_2}`} className='w-12 h-12 object-cover rounded-lg' alt="" />
                          ) : null}
                          {manutencao.photo_3 ? (
                            <img src={`${process.env.https://bikemobi.com.br/api}/manutencaoFoto/${manutencao.photo_3}`} className='w-12 h-12 object-cover rounded-lg' alt="" />
                          ) : null}
                        </div>
                      </td>
