                                ...
                                {loading ? (
                                    ...
                                    bike ? (
                                        <div className='flex p-2 m-2 mt-3 bg-cinzaClaro rounded-lg'>
                                            <img src={`${process.env.https://bikemobi.com.br/api}/bicicletaFoto/${bike.photo_1}`} className='w-14 h-14 object-cover rounded-lg mr-4' alt="" />
                            ...
                            {loja ? (
                                <div className='flex justify-between p-2 m-2 mt-3 bg-cinzaClaro rounded-lg'>
                                    <div>
                                        ...
                                        <img src={`${process.env.https://bikemobi.com.br/api}/lojaFoto/${loja?.photo}`} className='w-36 h-36 object-cover rounded-lg mr-4' alt="" />
                                    </div>
